 ...
 let handleLoading = (path) =>{
  ...
  <section className="relative w-full overflow-hidden pt-16" >
    ...
    <div className="sliding-carousel relative z-0">
      ...
      <img src="/Images/wedding.jpg" className="h-96 object-cover rounded-lg shadow-lg" alt="Banners" />
      <img src="/Images/bag.jpg" className="h-96 object-cover rounded-lg shadow-lg" alt="Stationery" />
