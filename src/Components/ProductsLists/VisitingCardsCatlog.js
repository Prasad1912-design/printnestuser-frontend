...
import "../../Components_Css/VisitingOrder.css";
...
const VisitingCardsCatlog = () => {
  const renderStars = (rating) => (
    <span className="rating-visiting text-yellow-400">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {products.map((p) => (
            <div key={p.id} className="product-card shadow-xl">
              <div className="product-id-visiting">#{p.id}</div>
              <img src={p.img} alt={p.name} className="product-image" />
              <div className="product-content-visiting">
                <h3 className="product-title-visiting">{p.name}</h3>
                <p className="product-desc-visiting">{p.desc}</p>
                <p className="product-price-visiting">{p.price}</p>
                <div className="product-rating-visiting">{renderStars(p.rating)}</div>
...
export default VisitingCardsCatlog;
