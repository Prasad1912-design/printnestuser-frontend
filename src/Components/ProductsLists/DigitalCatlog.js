...
import "../../Components_Css/Digital.css";
...
const DigitalCatlog = () => {
  const renderStars = (rating) => (
    <span className="rating-digital text-yellow-400">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {products.map((p) => (
            <div key={p.id} className="product-card shadow-xl">
              <div className="product-id-digital">#{p.id}</div>
              <img src={p.img} alt={p.name} className="product-image" />
              <div className="product-content-digital">
                <h3 className="product-title-digital">{p.name}</h3>
                <p className="product-desc-digital">{p.desc}</p>
                <p className="product-price-digital">{p.price}</p>
                <div className="product-rating-digital">{renderStars(p.rating)}</div>
