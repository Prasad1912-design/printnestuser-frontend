...
import "../../Components_Css/Invitation.css";
...
const InvitationCardsCatlog = () => {
  const renderStars = (rating) => (
    <span className="rating-invitation text-yellow-400">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {products.map((p) => (
            <div key={p.id} className="product-card shadow-xl">
              <div className="product-id-invitation">#{p.id}</div>
              <img src={p.img} alt={p.name} className="product-image" />
              <div className="product-content-invitation">
                <h3 className="product-title-invitation">{p.name}</h3>
                <p className="product-desc-invitation">{p.desc}</p>
                <p className="product-price-invitation">{p.price}</p>
                <div className="product-rating-invitation">{renderStars(p.rating)}</div>
...
export default InvitationCardsCatlog;
